...
ppgroup = 'https://i.ibb.co/RBx5SQC/avatar-group-large-v2.png?q=60'
			...
			if (res.announce == true) {
				...
				await sleep(2000)
				XeonBotInc.sendMessage(res.id, { 
					text: `「 Perubahan Pengaturan Grup 」\n\n*Deskripsi grup telah diubah*\n\n${res.desc}`,
				});
      } else {
				await sleep(2000)
				XeonBotInc.sendMessage(res.id, {
					text: `「 Perubahan Pengaturan Grup 」\n\n*Nama grup telah diubah*\n\n*${res.subject}*`,
				});
			} 
...
welcome(iswel, isLeft, XeonBotInc, anu)
})
...
XeonBotInc.before = (teks) => smsg(XeonBotInc, m, store)
